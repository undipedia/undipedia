  ...
  <div class="header-top">
    <div class="site-navbar py-2 js-sticky-header site-navbar-target d-none pl-0 d-lg-block" role="banner">
      ...
      <div class="row align-items-center">
        ...
        <a href="index.php" class="site-logo"><img src="images/logo.png" width="18%"> UNDIPedia</a>
      ...
      <div class="col-8 col-lg-6 d-flex">
        <nav class="site-navigation position-relative text-right" role="navigation">
          ...
          <li>
            <a href="categories.php?id=1" class="nav-link text-left">Categories</a>
          </li>
          <li>
            <a href="categories.php" class="nav-link text-left">Gallery</a>
          </li>
